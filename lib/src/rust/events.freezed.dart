...
return paymentFailed(_that);case SdkEvent_PaymentMetadataUpdated() when paymentMetadataUpdated != null:
return paymentMetadataUpdated(_that);case SdkEvent_AutoOptimization() when autoOptimization != null:
...
return paymentFailed(_that);case SdkEvent_PaymentMetadataUpdated():
return paymentMetadataUpdated(_that);case SdkEvent_AutoOptimization():
...
return paymentFailed(_that.payment);case SdkEvent_PaymentMetadataUpdated() when paymentMetadataUpdated != null:
return paymentMetadataUpdated(_that.payment);case SdkEvent_AutoOptimization() when autoOptimization != null:
...
return paymentFailed(_that.payment);case SdkEvent_PaymentMetadataUpdated():
return paymentMetadataUpdated(_that.payment);case SdkEvent_AutoOptimization():
...
class SdkEvent_PaymentMetadataUpdated extends SdkEvent {
  const SdkEvent_PaymentMetadataUpdated({required this.payment}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SdkEvent_PaymentMetadataUpdatedCopyWith<SdkEvent_PaymentMetadataUpdated> get copyWith => _$SdkEvent_PaymentMetadataUpdatedCopyWithImpl<SdkEvent_PaymentMetadataUpdated>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SdkEvent_PaymentMetadataUpdated&&(identical(other.payment, payment) || other.payment == payment));
}
...
@override
String toString() {
  return 'SdkEvent.paymentMetadataUpdated(payment: $payment)';
}
...
/// @nodoc
abstract mixin class $SdkEvent_PaymentMetadataUpdatedCopyWith<$Res> implements $SdkEventCopyWith<$Res> {
  factory $SdkEvent_PaymentMetadataUpdatedCopyWith(SdkEvent_PaymentMetadataUpdated value, $Res Function(SdkEvent_PaymentMetadataUpdated) _then) = _$SdkEvent_PaymentMetadataUpdatedCopyWithImpl;
@useResult
$Res call({
 Payment payment
});
...
/// @nodoc
class _$SdkEvent_PaymentMetadataUpdatedCopyWithImpl<$Res>
    implements $SdkEvent_PaymentMetadataUpdatedCopyWith<$Res> {
  _$SdkEvent_PaymentMetadataUpdatedCopyWithImpl(this._self, this._then);

  final SdkEvent_PaymentMetadataUpdated _self;
  final $Res Function(SdkEvent_PaymentMetadataUpdated) _then;

/// Create a copy of SdkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? payment = null,}) {
  return _then(SdkEvent_PaymentMetadataUpdated(
payment: null == payment ? _self.payment : payment // ignore: cast_nullable_to_non_nullable
as Payment,
  ));
}
...
class SdkEvent_UnilateralExitStateChanged extends SdkEvent {
  const SdkEvent_UnilateralExitStateChanged(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SdkEvent_UnilateralExitStateChanged);
}
...
@override
String toString() {
  return 'SdkEvent.unilateralExitStateChanged()';
}
