...
class AddContactRequest {
  ...
  const AddContactRequest({required this.name, required this.paymentIdentifier});

  @override
  int get hashCode => name.hashCode ^ paymentIdentifier.hashCode;
...
@freezed
sealed class ClaimDeferredReason with _$ClaimDeferredReason {
  const ClaimDeferredReason._();

  const factory ClaimDeferredReason.maxFeeExceeded({
    required BigInt requiredFeeSats,
    required BigInt maxFeeSats,
  }) = ClaimDeferredReason_MaxFeeExceeded;
  const factory ClaimDeferredReason.noEarlyClaimAvailable() = ClaimDeferredReason_NoEarlyClaimAvailable;
  const factory ClaimDeferredReason.providerDeclined({required String message}) =
      ClaimDeferredReason_ProviderDeclined;
}

@freezed
sealed class ClaimDepositOutcome with _$ClaimDepositOutcome {
  const ClaimDepositOutcome._();

  const factory ClaimDepositOutcome.settled({required Payment payment}) = ClaimDepositOutcome_Settled;
  const factory ClaimDepositOutcome.submitted() = ClaimDepositOutcome_Submitted;
  const factory ClaimDepositOutcome.deferred_({required ClaimDeferredReason reason}) =
      ClaimDepositOutcome_Deferred;
}
...
class ClaimDepositResponse {
  final ClaimDepositOutcome outcome;

  const ClaimDepositResponse({required this.outcome});
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ClaimDepositResponse && runtimeType == other.runtimeType && outcome == other.outcome;
}
...
class Contact {
  ...
  @override
  int get hashCode =>
      id.hashCode ^ name.hashCode ^ paymentIdentifier.hashCode ^ createdAt.hashCode ^ updatedAt.hashCode;
...
class ConversionEstimate {
  ...
  @override
  int get hashCode =>
      options.hashCode ^ amountIn.hashCode ^ amountOut.hashCode ^ fee.hashCode ^ amountAdjustment.hashCode;
...
class CrossChainAcceptedAsset {
  final SparkAsset asset;
  final CrossChainRouteLimits? limits;

  const CrossChainAcceptedAsset({required this.asset, this.limits});

  @override
  int get hashCode => asset.hashCode ^ limits.hashCode;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is CrossChainAcceptedAsset &&
          runtimeType == other.runtimeType &&
          asset == other.asset &&
          limits == other.limits;
}
...
class CrossChainReceiveInfo {
  ...
  int get hashCode =>
      ...
      serviceFeeAssetDecimals.hashCode ^
      expiresAt.hashCode;
  ...
  bool operator ==(Object other) =>
      ...
      other is CrossChainReceiveInfo &&
          ...
          serviceFeeAssetDecimals == other.serviceFeeAssetDecimals &&
...
class CrossChainRouteLimits {
  final BigInt? minAmount;
  final BigInt? maxAmount;
  final BigInt? minUsdCents;
  final BigInt? maxUsdCents;

  const CrossChainRouteLimits({this.minAmount, this.maxAmount, this.minUsdCents, this.maxUsdCents});

  @override
  int get hashCode => minAmount.hashCode ^ maxAmount.hashCode ^ minUsdCents.hashCode ^ maxUsdCents.hashCode;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is CrossChainRouteLimits &&
          runtimeType == other.runtimeType &&
          minAmount == other.minAmount &&
          maxAmount == other.maxAmount &&
          minUsdCents == other.minUsdCents &&
          maxUsdCents == other.maxUsdCents;
}
...
class CrossChainRoutePair {
  ...
  final List<CrossChainAcceptedAsset> acceptedAssets;
...
class ExternalLeafSigningKey {
  final ExternalTreeNodeId derivedFrom;

  const ExternalLeafSigningKey({required this.derivedFrom});

  @override
  int get hashCode => derivedFrom.hashCode;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ExternalLeafSigningKey && runtimeType == other.runtimeType && derivedFrom == other.derivedFrom;
}
...
class ExternalTransferLeafInput {
  ...
  final ExternalLeafSigningKey signingKey;

  const ExternalTransferLeafInput({required this.nodeId, required this.newLeafId, required this.signingKey});

  @override
  int get hashCode => nodeId.hashCode ^ newLeafId.hashCode ^ signingKey.hashCode;
...
sealed class InstantClaimStatus with _$InstantClaimStatus {
  ...
  const factory InstantClaimStatus.claimed() = InstantClaimStatus_Claimed;
}
...
class ListContactsRequest {
  ...
  const ListContactsRequest({this.offset, this.limit});
...
enum Network { mainnet, regtest, signet }
...
class UpdateContactRequest {
  ...
  const UpdateContactRequest({required this.id, required this.name, required this.paymentIdentifier});

  @override
  int get hashCode => id.hashCode ^ name.hashCode ^ paymentIdentifier.hashCode;
